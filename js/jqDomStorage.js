...
if ( typeof JSON.parse == "function" && window.localStorage && window.sessionStorage) {
	(function(exports, undefined) {
		...
		Database.prototype.find = function(obj) {
			...
			var keys = this.getKeys(obj), filtered = [], collection;
...
/*
 ...
 var persistent_db = new Database({
 name: 'AWS_DMS'
 });*/
...
/*
 ...
 var id = persistent_db.insert(obj);
 obj['mood'] = 'happy';
 persistent_db.update(id, obj);*/
