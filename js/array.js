...
Array.prototype.contains=function(a,b){var c=!1;void 0==b&&(b=!1);for(var d=0;d<this.length;d++)b?this[d]===a&&(c=!0):this[d]==a&&(c=!0);return c};Array.prototype.removeItem=function(a){for(var b=!1,c=0;c<this.length;c++)this[c]===a&&(b=this.splice(c,1));0==this.length&&"function"==typeof this.onDepleted&&this.onDepleted.apply(this);return b};Array.prototype.empty=function(a){void 0==a&&(a=!0);var b=this;a?this.forEach(function(a,d){b.removeItem(a)}):this.splice(0,this.length);return!0};
Array.prototype.unique=function(){var a=[];this.forEach(function(b,c){a.contains(b)||a.push(b)});return a};
Array.prototype.pickOne=function(a,b){var c=!1,d=this.onItemPicked;"function"==typeof b&&(d=b);null==a&&(a=Array.prototype.pickLast);if(0==this.length)"function"==typeof this.onDepleted&&this.onDepleted.apply(this);else{if(!0===a)var e=getRandomInt(0,this.length);a==Array.prototype.pickFirst&&(e=0);a==Array.prototype.pickLast&&(e=this.length-1);c=this.splice(e,1);"function"==typeof d&&d.apply(this,[c,e])}return c};
Array.prototype.pickRandomOne=function(a,b){var c=null,d=getRandomInt(0,this.length),e=this.onItemPicked;"function"==typeof b&&(e=b);c=a?this.splice(d,1):this[d];"function"==typeof e&&e.apply(this,[c,d]);return c};
